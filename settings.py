...
LANGUAGE_LIST = [
    "af", "sq", "am", "ar", "hy", "as", "az", "bm", "eu", "be", "bn", "bs", "bg",
    "my", "ca", "ckb", "zh", "hr", "cs", "da", "nl", "en", "et", "pi", "fi", "fr",
    "gl", "ka", "de", "el", "gu", "ha", "he", "hi", "hu", "is", "id", "it", "jp",
    "kn", "kz", "kh", "rw", "ko", "ku", "lv", "lt", "lb", "mk", "ms", "ml", "mt",
    "mi", "mr", "mn", "ne", "no", "or", "ps", "fa", "pl", "pt", "pa", "ro", "ru",
    "sm", "sr", "sn", "sd", "si", "sk", "sl", "so", "es", "sw", "sv", "tg", "ta",
    "te", "th", "zht", "tr", "tk", "uk", "ur", "uz", "vi", "cy", "zu"]

# Daily news timezone
DAILY_NEWS_TIMEZONE = datetime.datetime.now(pytz.timezone(os.getenv("TIMEZONE_NAME"))).tzinfo
